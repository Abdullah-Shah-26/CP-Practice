...
void solve(){
    ...
    auto check = [&](ll x){
      ...
      ll buyB = max(0LL, reqB - have[0]);
      ll buyS = max(0LL, reqS - have[1]);
      ll buyC = max(0LL, reqC - have[2]);

      ll cost = buyB * price[0] + buyS * price[1] + buyC * price[2];
